...
function Home() {
  ...
  useEffect(() => {
    ...
    if (country) country.DeathRate = (country.TotalDeaths / country.TotalRecovered * 100).toFixed(2);
            ...
            <Form.Group>
              ...
              <Row style={{ borderRadius: "25px" }}>
                <Col md={9}>
                  ...
                  <Form.Check id="deathrate-checkbox" className="float-left m-3" type="checkbox" label="death info" onChange={deathRateHandle} />
                </Col>
                <Col l={3}>
